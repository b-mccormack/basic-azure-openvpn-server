...
wget -O /etc/lighttpd/lighttpd.conf https://raw.githubusercontent.com/b-mccormack/basic-azure-openvpn-server/master/lighttpd.conf

#install the webserver scripts
rm /var/www/html/*
wget -O /var/www/html/index.sh https://raw.githubusercontent.com/b-mccormack/basic-azure-openvpn-server/master/index.sh

wget -O /var/www/html/download.sh https://raw.githubusercontent.com/b-mccormack/basic-azure-openvpn-server/master/download.sh
